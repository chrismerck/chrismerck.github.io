...
date: 2024-07-24
description: Diving into the challenges of persisting device state to flash memory.
categories:
  - embedded
---
...
_Originally published on [Memfault's Interrupt blog](https://interrupt.memfault.com/blog/choosing-or-building-an-embedded-db)._
...
available in a small embedded system leads to steep tradeoffs in performance
...
for the task. ESP32 nvs_flash was in early days and the venerable FAT12 format
...
embedded database that we call *Beau*.

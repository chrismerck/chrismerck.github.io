...
Although I lack a completely satisfactory implementation, I've gotten close enough for a demonstration. Check out the video of the drivetrain part of the driving simulation. *(Editor's note: the original video embed is no longer available.)*
